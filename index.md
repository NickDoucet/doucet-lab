...
{%
  ...
  image="images/photo.jpg"
  link="projects"
  title="Enzyme engineering & design"
  flip=true
  style="bare"
  text=text
%}
...
- strong links to the **Pasteur Network** and international collaborators,  
- and a supportive, interdisciplinary environment for developing as independent scientists.
...
{%
  ...
  image="images/photo.jpg"
  link="team"
  title="Our environment & training"
  text=text
%}
